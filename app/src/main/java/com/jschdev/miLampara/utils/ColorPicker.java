package com.jschdev.miLampara.utils;
...
public class ColorPicker extends Dialog implements
    ...
    /**
     * Creator of the class. It will initialize the class with black color as
     * default
     *
    ...
    /**
     * Creator of the class. It will initialize the class with the rgb color
     * passed as default
     *
     * @param a The reference to the activity where the color picker is called
     ...
     *          <p/>
     *          If the value of the colors it's not in the right range (0 -
     *          255) it will be place at 0.
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            setContentView(R.layout.mcp_layout_lollipop);
        } else {
            setContentView(R.layout.mcp_layout_old);
        }
        ...
        codHex.setOnEditorActionListener(new EditText.OnEditorActionListener() {
            @Override
    ...
    /**
     * Method that syncrhonize the color between the bars, the view and the HEC
     * code text.
     *
    ...
    private void updateColorView(String s) {
        if (s.matches("-?[0-9a-fA-F]+")) {
            ...
            codHex.setError(c.getResources().getText(
                    R.string.materialcolorpicker__errHex));
        }
    }
    ...
    /**
     * Method called when the user change the value of the bars. This sync the
     * colors.
     *
     ...
     * <p/>
     * From Android Reference: The Color class defines methods for creating and
     * converting color ints. Colors are represented as packed ints, made up of
     * 4 bytes: alpha, red, green, blue. The values are unpremultiplied, meaning
     * any transparency is stored solely in the alpha component, and not in the
     * color components.
     *
